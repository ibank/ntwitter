...
Twitter.prototype.multipartPost = function(url, content, callback) {
  if (typeof content === 'function') {
    callback = content;
    content = null;
  }
...
Twitter.prototype.updateStatusWithMedia = function(text, media, params, callback) {
  ...
  var url = this.options.upload_base + '/statuses/update_with_media.json';
  var defaults = {
    'status': text,
    'media[]': media
  };
  params = utils.merge(defaults, params);
  this.multipartPost(url, params, callback);
  return this;
};
